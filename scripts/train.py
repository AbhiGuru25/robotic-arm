...
def train_sac(args, cfg: dict, device: str) -> None:
    """Placeholder: SAC training loop (implemented in Phase M3)."""
    print("[train] SAC implementation coming in Phase M3.")
    print("[train] For now, run with --algo sac only after M3 is complete.")
    sys.exit(0)
